...
export default function NotificationPreferencesPage() {
  ...
  const handleToggle = async (key: keyof NotificationPreferences, label: string) => {
    if (!localPreferences || !user) return

    const newValue = !localPreferences[key]
    
    // Optimistic update
    setLocalPreferences(prev => prev ? { ...prev, [key]: newValue } : null)
    ...
    <div className="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-card border rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <Switch 
            checked={localPreferences.appointmentUpdates} 
        ...
        <div className="bg-card border rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <Switch 
            checked={localPreferences.medicineReminders} 
        ...
        <div className="bg-card border rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <Switch 
            checked={localPreferences.telemedicineReminders} 
        ...
        <div className="bg-card border rounded-2xl p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <Switch 
            checked={localPreferences.feedbackUpdates} 
