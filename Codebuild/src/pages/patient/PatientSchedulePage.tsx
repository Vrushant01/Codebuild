...
import { Plus, Pill, Calendar as CalendarIcon, History, Search, Bell } from "lucide-react"
            ...
            {activeTab === "TODAY" && (
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
                ...
                {browserPermission !== "granted" && (
                  <div className="bg-primary/10 border border-primary/25 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm animate-in fade-in">
                    <div className="flex items-center gap-3.5">
                      <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center text-primary shrink-0 shadow-inner">
                        <Bell className="w-5 h-5" />
                      </div>
                      <div>
                        <p className="font-bold text-sm text-foreground">Enable Medicine Alerts (10 mins before & exact time)</p>
                        <p className="text-xs text-muted-foreground mt-0.5">Receive timely desktop & in-app alerts so you never miss a dose.</p>
                      </div>
                    </div>
                    <Button 
                      size="sm" 
                      ...
                      className="rounded-xl font-bold px-5 whitespace-nowrap w-full sm:w-auto h-10 shadow-sm"
                    >
                      Enable Alerts 🔔
                    </Button>
                  </div>
