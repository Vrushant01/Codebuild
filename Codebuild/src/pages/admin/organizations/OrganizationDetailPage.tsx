              ...
              <div className="flex-1">
                ...
                <div className="grid sm:grid-cols-2 gap-y-3 gap-x-6 text-sm">
                  <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span className="truncate">{org.address || "Address unavailable"}, {org.city}</span>
                  </div>
                  {(typeof org.contact === 'object' ? org.contact?.email : org.email) && (
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <Mail className="w-4 h-4 shrink-0 text-primary" />
                      <span className="truncate">{typeof org.contact === 'object' ? org.contact?.email : org.email}</span>
                    </div>
                  )}
                  {(typeof org.contact === 'object' ? org.contact?.phone : org.contact || org.phone) && (
                    <div className="flex items-center gap-2 text-muted-foreground">
                      <Phone className="w-4 h-4 shrink-0 text-primary" />
                      <span className="truncate">{typeof org.contact === 'object' ? org.contact?.phone : org.contact || org.phone}</span>
                    </div>
                  )}
                  {org.website && (
                    <div className="flex items-center gap-2 text-muted-foreground">
