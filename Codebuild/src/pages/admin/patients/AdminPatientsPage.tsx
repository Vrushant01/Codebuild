            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody className="divide-y divide-border">
                {filteredPatients.map((patient, idx) => (
                  <tr key={patient.id || patient._id || patient.patientId || `patient_${idx}`} className="hover:bg-muted/30 transition-colors">
                    <td className="px-6 py-4 font-medium">{patient.name || "Patient"}</td>
