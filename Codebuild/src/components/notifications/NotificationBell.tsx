...
export function NotificationBell() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[380px] p-0 mr-4 shadow-xl rounded-2xl overflow-hidden" align="end">
        ...
        <div className="p-2 border-t bg-muted/20">
          <Button 
            variant="ghost" 
            className="w-full justify-center text-sm font-semibold text-primary hover:bg-primary/5"
            onClick={() => {
